  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        scale={0.01}
      >
        {/* MeshStandardMaterial as a tool in Three.js for making objects in your 3D scene look more realistic. It helps you control how objects reflect light, what color they are, how smooth or rough they look, and even how metallic they appear.

For example, if you want to create a shiny metal surface, you can adjust properties like metalness and roughness to make it look more like metal. If you want to add a texture to make it look like wood or stone, you can do that too. */}
