...
const Lights = () => {
  return (
    ...
    <group name="lights">
      ...
      {/* The primary purpose of the Environment component in @react-three/drei is indeed to provide reflections and lighting effects in your Three.js scene */}
      
      {/* environment also help to provide background to the scene */}
